...
module("DB_TaskCampaign", package.seeall)
...
function getDataById(key_id)
    local id_data = TaskCampaign[key_id]
...
function getArrDataByField(fieldName, fieldValue)
    local arrData = {}
    for k, v in pairs(TaskCampaign) do
...
function release()
    _G["DB_TaskCampaign"] = nil
    package.loaded["DB_TaskCampaign"] = nil
    package.loaded["DBSystem/DB_TaskCampaign"] = nil
end
