...
-- spine文件格式
cc.SPINE_FILETYPE_JSON = 0x0
cc.SPINE_FILETYPE_BINARY = 0x1
-- spine渲染类型
cc.RENDER_TYPE_HERO = 0x0
cc.RENDER_TYPE_HERO_WEAPON = 0x1
cc.RENDER_TYPE_MONSTER = 0x2
cc.RENDER_TYPE_NPC = 0x3
cc.RENDER_TYPE_ANIMATION = 0x4
cc.RENDER_TYPE_BLEND_ANIMATION = 0x5
---------------------------------
-- richText对齐方式
cc.RICHTEXT_HORALIGN_LEFT    = 0x0
cc.RICHTEXT_HORALIGN_RIGHT   = 0x1
cc.RICHTEXT_VERALIGN_TOP     = 0x0
cc.RICHTEXT_VERALIGN_MIDDLE  = 0x1
cc.RICHTEXT_VERALIGN_BOTTM   = 0x2
----------------------------------
-- setScenceImg的type
cc.SPRITE_SCENEIMG_JPG = 0x1
cc.SPRITE_SCENEIMG_PNG = 0x2
cc.SPRITE_SCENEIMG_JPGPNG = 0x3
---------------------------------
...
cc.PROGRESS_TIMER_TYPE_SLOPBAR  = 0x2
