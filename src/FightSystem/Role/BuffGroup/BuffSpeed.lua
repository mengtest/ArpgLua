...
BuffSpeed = class("BuffSpeed")

function BuffSpeed:ctor(_role, _buffCon, _releaser, _dbState, _dbEff)
	self.mRole = _role
	...
	--
	self.mRole.mPropertyCon:ChangeProperty("speed", self.mValue)
	self.mBuffCon:addLightEffect(_dbState,self)
end

function BuffSpeed:Destroy()
