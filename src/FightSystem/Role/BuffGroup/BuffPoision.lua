...
BuffPoision = class("BuffPoision")

function BuffPoision:ctor(_role, _buffCon, _releaser, _dbState, _dbEff, _level, _processType, _subhost)
	self.mRole = _role
...
function BuffPoision:Tick(delta)
	if #self.mEffect ~= 0 then
		for i,v in ipairs(self.mEffect) do
